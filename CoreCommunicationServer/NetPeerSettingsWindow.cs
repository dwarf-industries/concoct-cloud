namespace WWServer
{
    ...
    class NetPeerSettingsWindow : IDisposable
    {
        public NetPeer Peer;
        public Timer timer;
...
#if DEBUG
#pragma warning disable CS0168 // The variable 'f' is declared but never used
            float f;
#pragma warning restore CS0168 // The variable 'f' is declared but never used
