#pragma checksum "D:\RokonoControl\Views\Dashboard\AddNewProject.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a7e316b8b6bda33b7bc211c8db7bfa4763674ef2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a7e316b8b6bda33b7bc211c8db7bfa4763674ef2", @"/Views/Dashboard/AddNewProject.cshtml")]
...
<div class=""container-fluid"">
  ...
  ");
    ...
    <div tabindex=""3"" class=""e-card"" id=""Iss"">
        <div class=""e-card-header"">
            <div clas");
            WriteLiteral(@"s=""e-card-header-caption"">
                <div class=""e-card-header-title"">Project Settings</div>
            </div>
        </div>
        <div class=""e-card-content"">
...
<script>
    ...
    $(document).ready(function () {
     ...
     ");
            WriteLiteral(@"   IterationOptions = new ejs.buttons.Switch({ checked: true });
    ...
    function LoadAccounts(data) {
        ...
        grid = new ej.grids.Grid({
            ...
            columns: [
                 { field: 'name',  headerTe");
            WriteLiteral(@"xt: 'Name', width: 180 },
    ...
    function CreateNewProject() {
        ...
        var dto = {
            ...
            ""Users"": ActiveUsersGrid.getSelectedRecords(),// get the selected records.
            ""Iterations"": GridIterations.getSelectedRecords()
        }
        $.ajax({
            type: 'POST',
    ...
    function AddSelectedUser() {
        if (WorkIt");
            WriteLiteral(@"emOption.properties.checked === true)
        ...
        ActiveUse");
            WriteLiteral(@"rsGrid.addRecord(CurrentSelected);
