#pragma checksum "/home/dwarfdevelopment/Projects/GitClones/RokonoControl/Platform/Views/Survey/CreateNewSurvey.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e3c13869963efc93aa4a348a95f81477fa81b31e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e3c13869963efc93aa4a348a95f81477fa81b31e", @"/Views/Survey/CreateNewSurvey.cshtml")]
...
function drop(args)
{
    ...
    $.get(""/Survey/GetProjectSurveyElement?element=""+draggableId.nodeValue,function(data) {
        $(""#C");
            WriteLiteral(@"ontent"").append(data);
    });

    $.get(""/Survey/GetProjectSurveyElementSetting?element=""+draggableId.nodeValue,function(data) {
        $(""#Settings"").html("""");
