<<<<<<< HEAD:Platform/obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
...
=======
#pragma checksum "/home/kristifor/Projects/Webplatforms/RokonoControl/Views/Commit/CommitData.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "97c5b0482413091891b8a167330fe60363821efd"
>>>>>>> changing the UI interface to use only controls due to copyright issues with the last template as it can't be redustributed under MIT, adding base logic for linking work items. Removing a bug causing work items to be duplicated. Upgrading the kahaban board to v2 syncfusion:obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
// <auto-generated/>
...
=======
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "97c5b0482413091891b8a167330fe60363821efd4493", async() => {
>>>>>>> changing the UI interface to use only controls due to copyright issues with the last template as it can't be redustributed under MIT, adding base logic for linking work items. Removing a bug causing work items to be duplicated. Upgrading the kahaban board to v2 syncfusion:obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
            }
            );
...
<script src=""https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js"" integrity=""sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo"" crossor");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97c5b0482413091891b8a167330fe60363821efd6922", async() => {
>>>>>>> changing the UI interface to use only controls due to copyright issues with the last template as it can't be redustributed under MIT, adding base logic for linking work items. Removing a bug causing work items to be duplicated. Upgrading the kahaban board to v2 syncfusion:obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
...
=======
#line 54 "/home/kristifor/Projects/Webplatforms/RokonoControl/Views/Commit/CommitData.cshtml"
>>>>>>> changing the UI interface to use only controls due to copyright issues with the last template as it can't be redustributed under MIT, adding base logic for linking work items. Removing a bug causing work items to be duplicated. Upgrading the kahaban board to v2 syncfusion:obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
                                             Write(commitKey);
...
=======
#line 105 "/home/kristifor/Projects/Webplatforms/RokonoControl/Views/Commit/CommitData.cshtml"
>>>>>>> changing the UI interface to use only controls due to copyright issues with the last template as it can't be redustributed under MIT, adding base logic for linking work items. Removing a bug causing work items to be duplicated. Upgrading the kahaban board to v2 syncfusion:obj/Debug/netcoreapp3.1/Razor/Views/Commit/CommitData.cshtml.g.cs
                                                                     Write(BranchId);
